...
import org.weishao.annotation.*;
import org.weishao.exception.DeploymentException;
    ...
    private static PojoPathParam[] getPathParams(Method m, MethodType methodType) throws DeploymentException {
        ...
        for (int i = 0; i < types.length; i++) {
            ...
            if (type.equals(Session.class)) {
                ...
                throw new DeploymentException(
                        "expect to import org.weishao.pojo.Session not " + type.getName());
                ...
                throw new DeploymentException(
                        "expect to import org.weishao.pojo.ParameterMap not " + type.getName());
            } else {
                throw new DeploymentException(

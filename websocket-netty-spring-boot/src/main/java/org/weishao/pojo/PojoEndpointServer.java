...
import org.weishao.standard.ServerEndpointConfig;
...
/**
 * POJO（Plain Ordinary Java Object）简单的Java对象，实
 * 际就是普通JavaBeans，是为了避免和EJB混淆所创造的简称。
 */
public class PojoEndpointServer {
    ...
    public void doOnOpen(ChannelHandlerContext ctx, FullHttpRequest req, String path, String originalParam) {
        ...
        Attribute<Object> attrPojo = channel.attr(POJO_KEY);

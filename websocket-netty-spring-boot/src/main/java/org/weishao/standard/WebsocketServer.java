...
import org.weishao.pojo.PojoEndpointServer;
...
public class WebsocketServer {
    ...
    public void init() throws InterruptedException {
        ...
        logger.info("Open websocket server on {}:{}{}",config.getHost(),config.getPort(),config.getPathSet().toString());
